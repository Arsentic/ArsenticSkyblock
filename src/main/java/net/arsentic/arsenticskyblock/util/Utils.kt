...
object Utils {
    ...
    fun getIslandPlaceholders(island: Island): MutableList<Placeholder> {
        return ArrayList(
            listOf( // Upgrades
                Placeholder("sizevaultcost", if (ArsenticSkyblock.Companion.getUpgrades()!!.sizeUpgrade.upgrades.containsKey(island.getSizeLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.sizeUpgrade.upgrades.get(island.getSizeLevel() + 1)!!.vaultCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("membervaultcost", if (ArsenticSkyblock.Companion.getUpgrades()!!.memberUpgrade.upgrades.containsKey(island.getMemberLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.memberUpgrade.upgrades.get(island.getMemberLevel() + 1)!!.vaultCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("warpvaultcost", if (ArsenticSkyblock.Companion.getUpgrades()!!.warpUpgrade.upgrades.containsKey(island.getWarpLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.warpUpgrade.upgrades.get(island.getWarpLevel() + 1)!!.vaultCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("oresvaultcost", if (ArsenticSkyblock.Companion.getUpgrades()!!.oresUpgrade.upgrades.containsKey(island.getOreLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.oresUpgrade.upgrades.get(island.getOreLevel() + 1)!!.vaultCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("sizecrystalscost", if (ArsenticSkyblock.Companion.getUpgrades()!!.sizeUpgrade.upgrades.containsKey(island.getSizeLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.sizeUpgrade.upgrades.get(island.getSizeLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("membercrystalscost", if (ArsenticSkyblock.Companion.getUpgrades()!!.memberUpgrade.upgrades.containsKey(island.getMemberLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.memberUpgrade.upgrades.get(island.getMemberLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("warpcrystalscost", if (ArsenticSkyblock.Companion.getUpgrades()!!.warpUpgrade.upgrades.containsKey(island.getWarpLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.warpUpgrade.upgrades.get(island.getWarpLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("orescrystalscost", if (ArsenticSkyblock.Companion.getUpgrades()!!.oresUpgrade.upgrades.containsKey(island.getOreLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.oresUpgrade.upgrades.get(island.getOreLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("sizecost", if (ArsenticSkyblock.Companion.getUpgrades()!!.sizeUpgrade.upgrades.containsKey(island.getSizeLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.sizeUpgrade.upgrades.get(island.getSizeLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("membercost", if (ArsenticSkyblock.Companion.getUpgrades()!!.memberUpgrade.upgrades.containsKey(island.getMemberLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.memberUpgrade.upgrades.get(island.getMemberLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("warpcost", if (ArsenticSkyblock.Companion.getUpgrades()!!.warpUpgrade.upgrades.containsKey(island.getWarpLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.warpUpgrade.upgrades.get(island.getWarpLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("generatorcost", if (ArsenticSkyblock.Companion.getUpgrades()!!.oresUpgrade.upgrades.containsKey(island.getOreLevel() + 1)) ArsenticSkyblock.Companion.getUpgrades()!!.oresUpgrade.upgrades.get(island.getOreLevel() + 1)!!.crystalsCost.toString() + "" else getMessages().maxlevelreached),
                Placeholder("sizeblocks", ArsenticSkyblock.Companion.getUpgrades()!!.sizeUpgrade.upgrades.get(island.getSizeLevel())!!.size.toString() + ""),
                Placeholder("membercount", ArsenticSkyblock.Companion.getUpgrades()!!.memberUpgrade.upgrades.get(island.getMemberLevel())!!.size.toString() + ""),
                Placeholder("warpcount", ArsenticSkyblock.Companion.getUpgrades()!!.warpUpgrade.upgrades.get(island.getWarpLevel())!!.size.toString() + ""),
